        ...
        <div className="card-base p-5 mb-5">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            ...
            {!complaint.isEscalated && complaint.status !== "resolved" && (
              <button onClick={escalate} className="flex items-center gap-1.5 text-xs text-red-600 border border-red-300 px-3 py-2 rounded-md hover:bg-red-50 transition-colors w-fit flex-shrink-0">
